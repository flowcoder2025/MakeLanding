...
- [ ] WI-008-feat 네비게이션 바 컴포넌트 | L1:Codegen > L2:컴포넌트 | batch:B
- [ ] WI-009-feat CTA 버튼 컴포넌트 | L1:Codegen > L2:컴포넌트 | batch:C
- [ ] WI-010-feat 페이지 어셈블러 구현 | L1:Codegen > L2:조합 | batch:D

## L1: 프리뷰 & 출력
- [ ] WI-011-feat 프리뷰 서버 구현 | L1:Preview > L2:서버 | batch:A
- [ ] WI-012-feat 프로젝트 내보내기 | L1:Preview > L2:출력 | batch:B

## L1: 오케스트레이션
- [ ] WI-013-feat 메인 파이프라인 오케스트레이터 | L1:Pipeline > L2:오케스트레이션 | batch:A
